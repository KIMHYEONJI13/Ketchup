...
public class Notice {
    ...
    public Notice(int noticeNo, String memberNo, char noticeFix, String noticeTitle, String noticeContent, Timestamp noticeCreateDttm, Timestamp noticeUpdateDttm) {
